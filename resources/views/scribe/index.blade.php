                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-PUTapi-admin-users--user_id-">PUT api/admin/users/{user_id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-admin-users--user_id--reset-password">
                                <a href="#endpoints-POSTapi-admin-users--user_id--reset-password">POST api/admin/users/{user_id}/reset-password</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-owner-tenants">POST api/owner/tenants</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-owner-tenants--user_id-">
                                <a href="#endpoints-PUTapi-owner-tenants--user_id-">PUT api/owner/tenants/{user_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-owner-tenants--user_id-">
                                <a href="#endpoints-DELETEapi-owner-tenants--user_id-">DELETE api/owner/tenants/{user_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-tenant-me">
                                <a href="#endpoints-GETapi-tenant-me">GET api/tenant/me</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-tenant-assignments">
                                <a href="#endpoints-GETapi-tenant-assignments">GET api/tenant/assignments</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-properties">POST api/properties</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-properties--property_id-">
                                <a href="#endpoints-GETapi-properties--property_id-">GET api/properties/{property_id}</a>
                            </li>
                                ...
                                <a href="#endpoints-PUTapi-properties--property_id-">PUT api/properties/{property_id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-properties--property_id-">
                                <a href="#endpoints-DELETEapi-properties--property_id-">DELETE api/properties/{property_id}</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-properties--property_id--photos">POST api/properties/{property_id}/photos</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-properties--property_id--rooms">
                                <a href="#endpoints-GETapi-properties--property_id--rooms">GET api/properties/{property_id}/rooms</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-properties--property_id--rooms">
                                <a href="#endpoints-POSTapi-properties--property_id--rooms">POST api/properties/{property_id}/rooms</a>
                            </li>
                                ...
                                <a href="#endpoints-PUTapi-rooms--room_id-">PUT api/rooms/{room_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-rooms--room_id-">
                                <a href="#endpoints-DELETEapi-rooms--room_id-">DELETE api/rooms/{room_id}</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-rooms--room_id--photos">POST api/rooms/{room_id}/photos</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-owner-rooms">
                                <a href="#endpoints-GETapi-owner-rooms">GET api/owner/rooms</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-owner-assignments">
                                <a href="#endpoints-POSTapi-owner-assignments">POST api/owner/assignments</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-owner-assignments--assignment-">
                                <a href="#endpoints-DELETEapi-owner-assignments--assignment-">DELETE api/owner/assignments/{assignment}</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-me-change-password">POST api/me/change-password</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://inz.test/api/admin/users" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>Must be 11 characters. Example: <code>sitcpscqldz</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-admin-users--user_id--reset-password">POST api/admin/users/{user_id}/reset-password</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>This field is required unless <code>send_email</code> is in <code>true</code>. Must be at least 8 characters. Example: <code>|]|{+-</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-owner-tenants">GET api/owner/tenants</h2>
...
<p>Must be 11 characters. Example: <code>sitcpscqldz</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-owner-tenants--user_id-">PUT api/owner/tenants/{user_id}</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must not be greater than 12 characters. Example: <code>jnik</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>birth_date</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>Must be 11 characters. Example: <code>hwaykcmyuwp</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-owner-tenants--user_id-">DELETE api/owner/tenants/{user_id}</h2>
...
<p>The ID of the user. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-tenant-me">GET api/tenant/me</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-tenant-assignments">GET api/tenant/assignments</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-properties--property_id-">GET api/properties/{property_id}</h2>
...
<p>The ID of the property. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-properties--property_id-">DELETE api/properties/{property_id}</h2>
...
<p>Must be a file. Must be an image. Must not be greater than 5120 kilobytes.</p>
                    ...
                    <h2 id="endpoints-GETapi-properties--property_id--rooms">GET api/properties/{property_id}/rooms</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://inz.test/api/properties/1/rooms" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>The ID of the property. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-properties--property_id--rooms">POST api/properties/{property_id}/rooms</h2>
...
<p>The ID of the room. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-rooms--room_id-">PUT api/rooms/{room_id}</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
    ...
    <br>
                    ...
                    <h2 id="endpoints-DELETEapi-rooms--room_id-">DELETE api/rooms/{room_id}</h2>
...
<p>Must be a file. Must be an image. Must not be greater than 5120 kilobytes.</p>
                    ...
                    <h2 id="endpoints-GETapi-owner-rooms">GET api/owner/rooms</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://inz.test/api/owner/rooms" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<p>The <code>id</code> of an existing record in the properties table. Example: <code>16</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-owner-assignments">POST api/owner/assignments</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the contracts table. Example: <code>16</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Example: <code>false</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-owner-assignments--assignment-">DELETE api/owner/assignments/{assignment}</h2>
